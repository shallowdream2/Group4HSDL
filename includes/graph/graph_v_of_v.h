...
template <typename weight_type>
void graph_v_of_v<weight_type>::remove_edge(int e1, int e2) {
...
template <typename weight_type>
void graph_v_of_v<weight_type>::remove_all_adjacent_edges(int v) {
...
template <typename weight_type>
bool graph_v_of_v<weight_type>::contain_edge(int e1, int e2) {
...
template <typename weight_type>
weight_type graph_v_of_v<weight_type>::edge_weight(int e1, int e2) {
...
template <typename weight_type>
long long int graph_v_of_v<weight_type>::edge_number() {
...
template <typename weight_type>
void graph_v_of_v<weight_type>::print() {
...
template <typename weight_type>
void graph_v_of_v<weight_type>::clear() {

	return std::vector<std::vector<std::pair<int, weight_type>>>().swap(ADJs);
}

template <typename weight_type>
int graph_v_of_v<weight_type>::degree(int v) {

	return ADJs[v].size();
}

template <typename weight_type>
int graph_v_of_v<weight_type>::search_adjv_by_weight(int e1, weight_type ec) {
...
template <typename weight_type>
void graph_v_of_v<weight_type>::txt_save(std::string save_name) {
	...
	outputFile << "|E|= " << graph_v_of_v<weight_type>::edge_number() << std::endl;
	outputFile << std::endl;
...
template <typename weight_type>
void graph_v_of_v<weight_type>::binary_read(std::string save_name) {
...
template <typename weight_type>
ARRAY_graph<weight_type> graph_v_of_v<weight_type>::toARRAY() {
